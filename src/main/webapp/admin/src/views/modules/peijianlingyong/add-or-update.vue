<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="领用编号" prop="lingyongbianhao">
            <el-input v-model="ruleForm.lingyongbianhao" 
                placeholder="领用编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lingyongbianhao" label="领用编号" prop="lingyongbianhao">
              <el-input v-model="ruleForm.lingyongbianhao" 
                placeholder="领用编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="领用日期" prop="lingyongriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.lingyongriqi" 
                type="date"
                placeholder="领用日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lingyongriqi" label="领用日期" prop="lingyongriqi">
              <el-input v-model="ruleForm.lingyongriqi" 
                placeholder="领用日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='lingyongbianhao'){
            this.ruleForm.lingyongbianhao = obj[o];
	    this.ro.lingyongbianhao = true;
            continue;
          }
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='lingyongriqi'){
            this.ruleForm.lingyongriqi = obj[o];
	    this.ro.lingyongriqi = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `peijianlingyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.peijianlingyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
