<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="维修项目" prop="weixiuxiangmu">
          <el-select v-model="ruleForm.weixiuxiangmu" placeholder="请选择维修项目">
            <el-option
                v-for="(item,index) in weixiuxiangmuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm78p27/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
