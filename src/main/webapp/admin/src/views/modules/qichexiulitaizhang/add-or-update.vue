<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="零件" prop="lingjian">
          <el-input v-model="ruleForm.lingjian" 
              placeholder="零件" clearable  :readonly="ro.lingjian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="零件" prop="lingjian">
              <el-input v-model="ruleForm.lingjian" 
                placeholder="零件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修总额" prop="weixiuzonge">
          <el-input v-model="ruleForm.weixiuzonge" 
              placeholder="维修总额" clearable  :readonly="ro.weixiuzonge"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修总额" prop="weixiuzonge">
              <el-input v-model="ruleForm.weixiuzonge" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="零件费" prop="lingjianfei">
          <el-input v-model="ruleForm.lingjianfei" 
              placeholder="零件费" clearable  :readonly="ro.lingjianfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="零件费" prop="lingjianfei">
              <el-input v-model="ruleForm.lingjianfei" 
                placeholder="零件费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongji: {
      get: function () {
        return 0+parseFloat(this.ruleForm.weixiuzonge==""?0:this.ruleForm.weixiuzonge)+parseFloat(this.ruleForm.lingjianfei==""?0:this.ruleForm.lingjianfei) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weixiuxiangmu = true;
          ...
          if(o=='lingjian'){
            this.ruleForm.lingjian = obj[o];
	    this.ro.lingjian = true;
            continue;
          }
          if(o=='weixiuzonge'){
	    ...
	    this.ro.weixiuzonge = true;
          ...
          if(o=='lingjianfei'){
            this.ruleForm.lingjianfei = obj[o];
	    this.ro.lingjianfei = true;
            continue;
          }
          if(o=='zongji'){
    ...
    info(id) {
      this.$http({
        url: `qichexiulitaizhang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qichexiulitaizhang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qichexiulitaizhangCrossAddOrUpdateFlag = false;
                  this.parent.search();
